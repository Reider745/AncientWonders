    ...
    createGui: function(player, name){
        ...
        for(let a in key){
            ...
            for(let i in keysElem){
                ...
                if(obj2.cellX){
                    obj2.x = ((obj2.size+10)*obj2.cellX)-obj2.size+10;
                }
                if(obj2.cellY){
                    obj2.y = (obj2.size*obj2.cellY)-obj2.size+40;
                }
                let arr = [];
            ...
            if(obj.isVisual(player, name)){
                UITabbed.setTab(obj.id, {
                    ...
                    location: {
                        ...
                        x: 150,
                        y: 50,
                        scrollY: obj.height || 250,
                        scrollX: obj.width || 500
                    },
                    drawing: draw,
                    elements: elem
